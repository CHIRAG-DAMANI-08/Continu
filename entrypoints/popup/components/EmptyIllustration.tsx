...
export function EmptyIllustration({
  ...
  return (
    <svg
      ...
      className={className}
      role="img"
      aria-label="No contexts yet"
    >
      <g transform="translate(-841.956 -428.663)">
        {/* Transparent dropzone container background to blend with theme */}
        <rect
          width="596"
          height="596"
          transform="translate(1205.956 474.116)"
          fill="transparent"
        />

        {/* Dashed dropzone border */}
        <path
        ...
        {/* Carried Context Card (Continu Purple) */}
        <path
